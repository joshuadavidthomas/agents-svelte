...
| `AgentToolEvents`         | `src/tests/agentToolEvents.svelte.test.ts`, socket replacement test in `src/tests/factoryLifecycle.svelte.test.ts`  | `src/tests-d/public-api.test-d.ts`, `src/tests-d/chat-api.test-d.ts`  | `examples/agents-as-tools` displays helper Agent runs beside matching tool calls | `README.md` |
